...
import {uploadOnCloudinary,getCloudinaryPublicId,deleteFromCloudinary} from  "../utils/cloudinary.js"
...
const updateUserAvatar = asyncHandler(async (req,res)=>{
    ...
    //TODO: Delete old image assignment on cloudinary

    // Find the user by ID to get the current avatar
    const user1 = await User.findById(req.user?._id);

    // TODO: Delete old image on Cloudinary if it exists
    if (user1.avatar) {
        const oldAvatarPublicId = getCloudinaryPublicId(user1.avatar); // Extract the public ID from the URL
